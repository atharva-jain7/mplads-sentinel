...
export default function ReportPage() {
  ...
  if (loading || !report) {
    return <div className="p-12 text-center text-slate-400 text-xs">Generating official report...</div>;
  }
  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto pb-12">
      ...
      {/* Official Government Printable Dossier */}
      <div className="bg-white border border-slate-300 p-8 sm:p-10 rounded-xl shadow-xs print:border-none print:shadow-none print:p-0 space-y-5 text-slate-900 font-sans">
        ...
        <div className="border-b-2 border-slate-900 pb-3 text-center space-y-0.5">
          <div className="text-[11px] font-bold uppercase tracking-widest text-slate-600">GOVERNMENT OF INDIA</div>
        ...
        {/* Section 2 & 3: Financial & Progress */}
        ...
        {/* Section 5: Explainable Findings */}
        <div className="space-y-1.5">
          <h3 className="text-xs font-bold uppercase tracking-wider bg-slate-100 p-1.5 text-slate-800 border-l-3 border-slate-800">
            5. EXPLAINABLE RISK FINDINGS
          </h3>
        ...
        {/* Section 6: Recommended Verification Steps */}
        <div className="space-y-1.5">
          <h3 className="text-xs font-bold uppercase tracking-wider bg-slate-100 p-1.5 text-slate-800 border-l-3 border-slate-800">
            6. MANDATORY VERIFICATION DIRECTIVES
          </h3>
...
print("ReportPage refactored cleanly.")