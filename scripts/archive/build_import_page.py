...
BASE = r"c:\Users\Atharva Jain\Desktop\mplads-sentinel\frontend\src\pages"

import_page_code = """import React, { useState } from 'react';
...
with open(os.path.join(BASE, "DataImportPage.jsx"), "w", encoding="utf-8") as f:
    f.write(import_page_code.strip())

print("DataImportPage created.")