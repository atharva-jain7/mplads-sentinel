...
# 1. Update ProjectController.java to add @PostMapping("/import-csv")
controller_code = """package com.sih26102.sentinel.controller;
...
with open(os.path.join(BASE, "controller", "ProjectController.java"), "w", encoding="utf-8") as f:
    f.write(controller_code.strip())

print("ProjectController updated.")