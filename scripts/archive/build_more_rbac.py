...
# 1. Update InvestigationPage.jsx with Jurisdiction RBAC check
...
# 2. Update ReportPage.jsx with Jurisdiction RBAC check
...
print("InvestigationPage and ReportPage updated with strict RBAC jurisdiction checks.")