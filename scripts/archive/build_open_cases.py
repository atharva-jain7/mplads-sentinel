...
# =========================================================================
# 1. ProjectListPage.jsx (Ministry & State Nodal can see ALL cases on net)
# =========================================================================
        ...
        <form onSubmit={handleSearch} className="flex flex-col sm:flex-row gap-2.5">
          ...
          {isLockedDistrict ? (
            ...
            >
              ...
              <option value="Mumbai Suburban">Mumbai (Maharashtra)</option>
...
# =========================================================================
# 2. ProjectDetailPage.jsx (Access control restricted ONLY for MP)
# =========================================================================
...
print("ProjectListPage and ProjectDetailPage updated.")