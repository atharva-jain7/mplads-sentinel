    ...
    <div className="space-y-6 font-sans">
      ...
      <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 self-end sm:self-center">
          <div className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-100 rounded-lg text-[11px] font-mono text-slate-700 border border-slate-200 shadow-2xs">
            <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
            <span>Last Data Updated: 11 September 2026, 21:45 IST</span>
          </div>
        </div>
      </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-xs overflow-hidden">
            <div className="p-4 sm:p-5 border-b border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-3.5 py-1.5 bg-slate-900 hover:bg-slate-800 text-white font-semibold rounded-lg text-xs flex items-center gap-1.5 transition-colors cursor-pointer shadow-xs"
                >
                  <span>View All Projects in Risk Priority</span>
                  <ArrowRight className="w-3.5 h-3.5" />
                </button>
              </div>
            </div>
            ...
            <div className="p-3 bg-slate-50/80 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-600 px-4 gap-2">
              <span className="font-mono text-[11px]">
                Showing top {Math.min(5, (filteredQueue !== null ? filteredQueue : (s.priorityQueue || [])).length)} of {(filteredQueue !== null ? filteredQueue : (s.priorityQueue || [])).length} prioritized works
              </span>
              <button
                onClick={() => {
                  const params = new URLSearchParams();
              ...
              >
                <span>View all projects in Project Risk Priority</span>
                <ArrowRight className="w-3.5 h-3.5" />
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-xs p-4 flex flex-col justify-between">
              <div className="flex items-center justify-between pb-3 border-b border-slate-100 mb-3">
                ...
                <div className="flex items-center gap-1.5 px-2.5 py-1 text-[11px] font-mono font-semibold text-emerald-700 bg-emerald-50 border border-emerald-200 rounded-lg">
                  <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
                  <span>OpenStreetMap • Real-Time</span>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-xs p-4 flex flex-col justify-between">
              <div className="flex items-center justify-between pb-3 border-b border-slate-100 mb-3">
                ...
                <div className="flex items-center gap-1.5 px-2.5 py-1 text-[11px] font-mono font-semibold text-slate-700 bg-slate-100 border border-slate-200 rounded-lg">
                  <span className="w-1.5 h-1.5 rounded-full bg-blue-500" />
                  <span>Scheme Telemetry</span>
                </div>
              </div>
